...
export class ToDoComponent implements OnInit {
  ...
  constructor(private datePipe: DatePipe, private inputService: InputService, private commonEnquiryService: CommonEnquiryService,
              private workItemService: WorkItemService, private router: Router, private tableService: TableService,
  ...
  clearSearchField() {
    console.log('** My TO DO before inside clear search field: ', this.value, " this.obj: ", this.obj)
    if (this.value !== "" && this.value !== undefined
    ...
    console.log('*** MY TO DO after inside clear search field: ', this.value)
  }
}
